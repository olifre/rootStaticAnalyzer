...
TString streamingUtils::streamObjectToBufferAndChecksum(TObject* obj) {
	static TBufferFile buf(TBuffer::kWrite, 10000);

	// NECESSARY: Reset the map of the buffer, we may be re-using it.

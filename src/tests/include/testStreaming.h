...
#ifndef __testStreaming_h__
#define __testStreaming_h__

#include "testInterface.h"

class testStreaming : public testInterface {
  protected:
  ...
  public:
	testStreaming() : testInterface("Streaming") { };
};

#endif /* __testStreaming_h__ */
